...
// Time: O(n), where n is the length of the strings being compared
...
// Time Complexity: O(n + m), where n is the number of strings in the input array, m is the number of distinct anagrams found from the strings
